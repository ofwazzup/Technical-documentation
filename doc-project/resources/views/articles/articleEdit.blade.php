...
@section('content')
    ...
    <h1 class="display-3">Редактируйте инструкцию</h1>
      @if ($errors->any())
    ...
    <form method="post" action="{{ route('articleEditSubmit', $idArticle = $data->id) }}">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="nameArticle" name="nameArticle" placeholder="Название инструкции" value="{{ old('nameArticle') }} {{ $data->nameArticle }}">
      </div>
